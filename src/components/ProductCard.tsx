...
const ProductCard = ({ product, onAddToCart, index }: ProductCardProps) => {
  ...
  return (
    <>
      ...
      <div id={`product-${product.id}`} className="bg-white rounded-2xl shadow-lg border-4 border-yellow-400 overflow-hidden hover:shadow-xl transition-all duration-300 hover:border-yellow-500 relative">
